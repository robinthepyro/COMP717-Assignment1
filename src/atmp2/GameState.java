...
public interface GameState<M extends Move<M>> {
     ...
     *         This method is intended for filtering moves based on specific game
     *         logic or heuristics
    ...
    /**
     * @return true if the game state is terminal (e.g., win, loss, draw), else
     *         false
     */
    boolean isTerminal();
     ...
     *
     *         However I encourage finding some intermediate heuristic to use in
     *         order to separate
     *         non terminal states when the minimax depth is too low
     * 
     *         Also, try using numbers bigger than +/- 1 on terminal states as this
     *         leaves
